...
12:"December"},monthClass:"",dayDefault:"Select day",dayValue:"",dayClass:"",hourDefault:"Pilih jam",hourValue:"",hourClass:"form-control",minuteDefault:"Pilih menit",minuteValue:"",minuteClass:"form-control",secondDefault:"Pilih detik",secondValue:"",secondClass:"form-control"},b);var m=[],k=[],n="",r={y:function(a){var c=b.yearMin,d=b.yearMax;a=a?a:b.yearValue;for(var e=b.yearDefault?'<option value="----">'+b.yearDefault+"</option>":"",f=c;f<=d;f++)c="",f==a&&(c="selected"),e+='<option value="'+f+'" '+c+">"+f+"</option>";return e},
